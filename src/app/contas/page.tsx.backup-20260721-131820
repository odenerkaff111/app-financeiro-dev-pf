...
export default function AccountsPage() {
  ...
  const summary = useMemo(() => {
    ...
    const investedAmount = activeAccounts
      .filter(
        (account) =>
    ...
    const creditCardInvoice = activeAccounts
      .filter(
        (account) =>
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center overflow-y-auto bg-[#0D1B2A]/55 p-4 backdrop-blur-sm">
